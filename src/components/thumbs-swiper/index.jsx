...
import slider from "../../pages/product-page/img/slider/slider.jpg";
    ...
    return (
            <div className='thumbs-swiper__slider-wrap' data-test-id='product-slider'>
                <div className='thumbs-swiper__ribbon'>
                    ...
                    <Swiper direction='vertical' slidesPerView={4} watchSlidesProgress spaceBetween={16} onSwiper={setThumbsSwiper} modules={[FreeMode, Navigation, Controller, Thumbs]} className="mySwiper">
